...
- `DUOTONE_SCHEME_NAMES`: ("teal" | "vermilion" | "pine" | "wisteria" | "rose" | "persimmon" | "indigo")[]
- `DUOTONE_SCHEMES`: { readonly teal: DuotoneScheme; readonly vermilion: DuotoneScheme; readonly pine: DuotoneScheme; readonly wisteria: DuotoneScheme; readonly rose: DuotoneSche…
- `DUSK`: Palette
...
- `REGALIA_SCHEME_NAMES`: ("rose" | "gold" | "meadow" | "dusk" | "bark")[]
