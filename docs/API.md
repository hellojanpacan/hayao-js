...
- `canonicalHandle`: (handle: string) => string
...
- `crestSvg`: (handle: string, opts?: CrestSvgOptions) => string
...
- `loop`: (id: string) => DrumLoop | undefined
...
- `renderAudioCard`: (buf: StereoBuffer, meta: AudioCardMeta) => string
...
- `stepPattern`: (grid: string, pitch: Pitch, opts?: StepGridOptions) => Note[]
