...
- `analyzePlaytest`: (def: GameDefinition, session: PlaytestSession, opts?: AnalyzeOptions) => PlaytestReport
...
- `bootDom`: (def: GameDefinition, mount?: HTMLElement | undefined) => DomHarness
...
- `scrubTo`: (world: World, def: GameDefinition, ring: SnapshotRing, inputFrames: readonly string[][], axesLog: readonly (readonly [number, string, number])[], knobEvents…
